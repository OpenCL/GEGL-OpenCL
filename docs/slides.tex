...
\begin{itemize}
\item Different datatypes and color models
\item Promotion
\item Overflow 
\end{itemize}
...
\begin{itemize}
\item Gimp Independent Language
\item Codegen
\end{itemize}

\nfoil{Gimp Independent Language}
\begin{itemize}
\item Data type and color model independent
...
\item Pixel varibles (variable-name[]/\_color/\_alpha
\item DT Macros  
\end{itemize}
...
\nfoil{Codegen}
\begin{itemize}
\item Parses Gimp Independent Language
\item Creates data type and color model specific code
\item Independ of data type and color model 
\end{itemize}
...
\item u16\_4k example:\\
DT\_MACROS\_BEGIN
DATATYPE\hfill guint16
