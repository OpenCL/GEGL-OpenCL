 ...
 */
  ...
  gegl_chant_double (in_low, -100.0, 100.0, 0.0,
      "Input luminance level to become lowest output")
  gegl_chant_double (in_high, -100.0, 100.0, 1.0, "Input luminance level to become white.")
  gegl_chant_double (out_low, -100.0, 100.0, 0.0, "Lowest luminance level in output")
  gegl_chant_double (out_high, -100.0, 100.0, 1.0, "Highest luminance level in output")
