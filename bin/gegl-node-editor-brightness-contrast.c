...
typedef struct _GeglNodeEditorBrightnessContrast      GeglNodeEditorBrightnessContrast;
typedef struct _GeglNodeEditorBrightnessContrastClass GeglNodeEditorBrightnessContrastClass;

struct _GeglNodeEditorBrightnessContrast
{
...
struct _GeglNodeEditorBrightnessContrastClass
{
  GeglNodeEditorClass parent_class;
};

static void gegl_node_editor_brightness_contrast_class_init (GeglNodeEditorBrightnessContrastClass   *klass);
static void gegl_node_editor_brightness_contrast_init       (GeglNodeEditorBrightnessContrast        *self);
static void construct                         (GeglNodeEditor             *editor);

G_DEFINE_TYPE (GeglNodeEditorBrightnessContrast, gegl_node_editor_brightness_contrast, GEGL_TYPE_NODE_EDITOR)

static void
gegl_node_editor_brightness_contrast_class_init (GeglNodeEditorBrightnessContrastClass *klass)
{
...
static void
gegl_node_editor_brightness_contrast_init (GeglNodeEditorBrightnessContrast *self)
{
}
...
event_press (GtkWidget *widget, GdkEventButton *bev, gpointer user_data)
{
  ...
  GeglNode       *node        = node_editor->node;
  cairo_t        *cr          = gegl_widget_get_cr (widget);
  GeglNodeEditorBrightnessContrast *self = user_data;
