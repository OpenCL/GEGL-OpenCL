...
static void class_init (GeglMockFilter22Class * klass);
static void init(GeglMockFilter22 *self, GeglMockFilter22Class *klass);
...
GType
gegl_mock_filter_2_2_get_type (void)
{
  static GType type = 0;
  ...
  if (!type)
    {
      ...
      {
        sizeof (GeglMockFilter22Class),
        (GBaseInitFunc) NULL,
        (GBaseFinalizeFunc) NULL,
        (GClassInitFunc) class_init,
        (GClassFinalizeFunc) NULL,
        NULL,
        sizeof (GeglMockFilter22),
        0,
...
static void
class_init (GeglMockFilter22Class * klass)
{
...
static void
init (GeglMockFilter22 * self,
      GeglMockFilter22Class * klass)
{
...
get_property (GObject      *gobject,
              ...
              GParamSpec   *pspec)
{
  GeglMockFilter22 *self = GEGL_MOCK_FILTER_2_2(gobject);
