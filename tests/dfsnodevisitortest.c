 ...
 */

  {
    ...
    GeglNode *C = g_object_new (GEGL_TYPE_MOCK_FILTER_1_1, "name", "C", NULL);  
    GeglNode *D = g_object_new (GEGL_TYPE_MOCK_FILTER_2_1, "name", "D", NULL);  
    GeglNode *E = g_object_new (GEGL_TYPE_MOCK_FILTER_2_1, "name", "E", NULL);  
    GeglNode *F = g_object_new (GEGL_TYPE_MOCK_FILTER_1_1, "name", "F", NULL);  
    GeglNode *G = g_object_new (GEGL_TYPE_MOCK_FILTER_0_1, "name", "G", NULL);  
