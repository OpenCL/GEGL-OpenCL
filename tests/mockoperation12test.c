...
{
  {
    GeglNode *a = g_object_new (GEGL_TYPE_MOCK_OPERATION_1_2, NULL);
    gint i;
...
static void
test_mock_operation_1_2_property_names(Test *test)
{
  {
    GeglNode *a = g_object_new (GEGL_TYPE_MOCK_OPERATION_1_2, NULL);
...
create_mock_operation_1_2_test()
{
  ...
  g_assert(ct_addTestFun(t, test_mock_operation_1_2_property_names));
#endif
