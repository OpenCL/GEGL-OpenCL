...
extern Test * create_fill_test_float();
extern Test * create_fill_test_uint8();
...
extern Test * create_float_array_test();
...
{  
...

  {
    ...
    cs_addTest(suite, create_fill_test_uint8());
    cs_addTest(suite, create_fill_test_float());
    cs_addTest(suite, create_float_array_test());
