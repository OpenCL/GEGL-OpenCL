...
extern Test * create_add_test_float();
extern Test * create_add_test_uint8();
...
extern Test * create_channels_test_float();
extern Test * create_check_op_test();
extern Test * create_color_model_test();
extern Test * create_color_space_test();
extern Test * create_color_test_float();
extern Test * create_color_test_uint8();
extern Test * create_copy_test_float();
extern Test * create_copy_test_uint8();
...
extern Test * create_fade_test_float();
extern Test * create_fade_test_uint8();
extern Test * create_graph_apply_test_float();
extern Test * create_graph_node_test();
extern Test * create_haverect_test();
extern Test * create_i_add_test_float();
extern Test * create_i_add_test_uint8();
extern Test * create_i_mult_test_float();
extern Test * create_i_mult_test_uint8();
...
extern Test * create_mult_test_float();
extern Test * create_mult_test_uint8();
extern Test * create_multiply_test_float();
extern Test * create_multiple_outputs_test();
extern Test * create_needrect_test();
extern Test * create_node_test();
extern Test * create_normal_test_float();
...
extern Test * create_simple_tree_test_float();
...
{  
...

  {
...
#if 1 
    cs_addTest(suite, create_add_test_float());
    cs_addTest(suite, create_add_test_uint8());
    ...
    cs_addTest(suite, create_channels_test_float());
    cs_addTest(suite, create_check_op_test());
    cs_addTest(suite, create_color_test_uint8());
    cs_addTest(suite, create_color_test_float());
    ...
    cs_addTest(suite, create_copy_test_float());
    cs_addTest(suite, create_copy_test_uint8());
    cs_addTest(suite, create_fade_test_float());
    cs_addTest(suite, create_fade_test_uint8());
    cs_addTest(suite, create_graph_apply_test_float());
    cs_addTest(suite, create_graph_node_test());
    cs_addTest(suite, create_haverect_test());
    cs_addTest(suite, create_i_add_test_float());
    cs_addTest(suite, create_i_add_test_uint8());
    cs_addTest(suite, create_i_mult_test_float());
    cs_addTest(suite, create_i_mult_test_uint8());
    ...
    cs_addTest(suite, create_mult_test_float());
    cs_addTest(suite, create_mult_test_uint8());
    cs_addTest(suite, create_multiply_test_float());
    cs_addTest(suite, create_multiple_outputs_test());
    cs_addTest(suite, create_needrect_test());
    cs_addTest(suite, create_node_test());
    cs_addTest(suite, create_normal_test_float());
    ...
    cs_addTest(suite, create_simple_tree_test_float());
