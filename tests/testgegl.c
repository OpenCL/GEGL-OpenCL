...
extern Test * create_float_value_test();
...
extern Test * create_rgb_float_value_test();
extern Test * create_rgb_uint8_value_test();
extern Test * create_simple_tree_test_rgb_float();
extern Test * create_storage_test();
extern Test * create_tile_test();
extern Test * create_uint8_value_test();
...
{  
...

  {
    ...
    cs_addTest(suite, create_float_value_test());
    ...
    cs_addTest(suite, create_rgb_float_value_test());
    cs_addTest(suite, create_rgb_uint8_value_test());
    cs_addTest(suite, create_simple_tree_test_rgb_float());
    cs_addTest(suite, create_storage_test());
    cs_addTest(suite, create_tile_test());
    cs_addTest(suite, create_uint8_value_test());
