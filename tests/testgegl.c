...
extern Test * create_add_test_pixel_rgb_float();
...
extern Test * create_color_test_pixel_rgb_float();
...
extern Test * create_fade_test_pixel_rgb_float();
extern Test * create_fade_test_rgb_uint8();
extern Test * create_graph_apply_test_pixel_rgb_float();
extern Test * create_graph_node_test();
extern Test * create_haverect_test();
extern Test * create_i_add_test_pixel_rgb_float();
extern Test * create_i_add_test_rgb_uint8();
extern Test * create_i_mult_test_pixel_rgb_float();
extern Test * create_i_mult_test_rgb_uint8();
extern Test * create_image_test();
extern Test * create_image_data_iterator_test();
extern Test * create_image_data_test();
extern Test * create_mult_test_pixel_rgb_float();
extern Test * create_mult_test_rgb_uint8();
extern Test * create_multiply_test_pixel_rgb_float();
...
extern Test * create_simple_tree_test_pixel_rgb_float();
extern Test * create_storage_test();
extern Test * create_tile_test();
extern Test * create_value_image_data_test();
...
{  
...

  {
    ...
    cs_addTest(suite, create_add_test_pixel_rgb_float());
    ...
    cs_addTest(suite, create_color_test_pixel_rgb_float());
    ...
    cs_addTest(suite, create_fade_test_pixel_rgb_float());
    cs_addTest(suite, create_fade_test_rgb_uint8());
    cs_addTest(suite, create_graph_apply_test_pixel_rgb_float());
    cs_addTest(suite, create_graph_node_test());
    cs_addTest(suite, create_haverect_test());
    cs_addTest(suite, create_i_add_test_pixel_rgb_float());
    cs_addTest(suite, create_i_add_test_rgb_uint8());
    cs_addTest(suite, create_i_mult_test_pixel_rgb_float());
    cs_addTest(suite, create_i_mult_test_rgb_uint8());
    cs_addTest(suite, create_image_test());
    cs_addTest(suite, create_image_data_iterator_test());
    cs_addTest(suite, create_image_data_test());
    cs_addTest(suite, create_mult_test_pixel_rgb_float());
    cs_addTest(suite, create_mult_test_rgb_uint8());
    cs_addTest(suite, create_multiply_test_pixel_rgb_float());
    ...
    cs_addTest(suite, create_simple_tree_test_pixel_rgb_float());
    cs_addTest(suite, create_storage_test());
    cs_addTest(suite, create_tile_test());
    cs_addTest(suite, create_value_image_data_test());
