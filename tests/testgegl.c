...
extern Test * create_add_impl_test();
...
extern Test * create_const_mult_impl_test();
extern Test * create_copy_test();
extern Test * create_impl_test();
extern Test * create_fill_impl_test();
extern Test * create_fill_test();
extern Test * create_image_mgr_test();
...
extern Test * create_op_impl_test();
extern Test * create_point_op_test();
extern Test * create_point_op_impl_test();
extern Test * create_print_test();
extern Test * create_print_impl_test();
extern Test * create_sampled_image_impl_test();
extern Test * create_sampled_image_test();
extern Test * create_simple_image_mgr_test();
extern Test * create_simpletree_test();
extern Test * create_stat_op_test();
extern Test * create_stat_op_impl_test();
extern Test * create_test_test();
extern Test * create_test_impl_test();
...
{  
...

  {
    ...
    cs_addTest(suite, create_add_impl_test());
    ...
    cs_addTest(suite, create_const_mult_impl_test());
    cs_addTest(suite, create_copy_test());
    cs_addTest(suite, create_fill_test());
    cs_addTest(suite, create_fill_impl_test());
    cs_addTest(suite, create_image_mgr_test());
    ...
    cs_addTest(suite, create_op_impl_test());
    cs_addTest(suite, create_point_op_test());
    cs_addTest(suite, create_point_op_impl_test());
    cs_addTest(suite, create_print_test());
    cs_addTest(suite, create_print_impl_test());
    cs_addTest(suite, create_node_test());
    cs_addTest(suite, create_sampled_image_impl_test());
    cs_addTest(suite, create_sampled_image_test());
    cs_addTest(suite, create_simple_image_mgr_test());
    cs_addTest(suite, create_simpletree_test());
    cs_addTest(suite, create_stat_op_test());
    cs_addTest(suite, create_stat_op_impl_test());
