...
{
  {
    ...
    ct_test(test, !strcmp("GeglMockFilter22", g_type_name(GEGL_TYPE_MOCK_FILTER_2_2)));

    g_object_unref(mock_filter_2_2);
  }
}
...
static void
mock_filter_2_2_test_setup(Test *test)
{
}

static void
mock_filter_2_2_test_teardown(Test *test)
{
}

Test *
create_mock_filter_2_2_test()
{
  Test* t = ct_create("GeglMockFilter22Test");
