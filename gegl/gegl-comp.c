              ...
              GParamSpec   *pspec)
{
  ...
  switch (prop_id)
  {
    case PROP_COMPOSITE_MODE:
      g_value_set_int(value, gegl_comp_get_composite_mode(comp));  
      break;
    default:
      break;
  }
              ...
              GParamSpec   *pspec)
{
  ...
  {
    case PROP_COMPOSITE_MODE:
      gegl_comp_set_composite_mode(comp, (GeglCompositeMode)g_value_get_int(value));  
      break;
    default:
      break;
  }
...
gegl_comp_get_composite_mode (GeglComp * self)
{
  ...
  g_return_val_if_fail (GEGL_IS_COMP (self), GEGL_COMPOSITE_MODE_NONE);
 ...
 **/
void 
gegl_comp_set_composite_mode (GeglComp * self, 
        ...
        while (width--)
          {
            ...
            *dest_alpha = alpha;
            ...
            if (alpha)
              {
                *dest_r = ((a * *src1_r + b * *src2_r) * 1.0) / alpha;
                *dest_g = ((a * *src1_g + b * *src2_g) * 1.0) / alpha;
                *dest_b = ((a * *src1_b + b * *src2_b) * 1.0) / alpha;
              }
            else
              {
                *dest_r = *src1_r;
        ...
        while (width--)
          {
            ...
            alpha = (1.0 - *src1_alpha) * *src2_alpha;
  ...
  gfloat *src2_data[4];
    ...
    switch(self->composite_mode)
      ...
      case GEGL_COMPOSITE_MODE_REPLACE:
	    ...
	    *dest_r = *src2_r * *src2_alpha;
	    *dest_g = *src2_g * *src2_alpha;
	    *dest_b = *src2_b * *src2_alpha;
        ...
        while (width--)
          {
            ...
            a = ((65535UL - *src2_alpha) * *src1_alpha) / 65535UL ;
            b = *src2_alpha;
            alpha = a + b;
            ...
            *dest_alpha = alpha;
            ...
            if (alpha)
              {
                *dest_r = (((a * *src1_r) / 65535UL  + (b * *src2_r) / 65535UL ) * 65535UL) / alpha;
                *dest_g = (((a * *src1_g) / 65535UL  + (b * *src2_g) / 65535UL ) * 65535UL) / alpha;
                *dest_b = (((a * *src1_b) / 65535UL  + (b * *src2_b) / 65535UL ) * 65535UL) / alpha;
              }
            else
              {
                *dest_r = *src1_r;
        ...
        while (width--)
          {
            ...
            alpha = (*src1_alpha * *src2_alpha) / 65535UL ;
        ...
        while (width--)
          {
            ...
            alpha = ((65535UL - *src1_alpha) * *src2_alpha) / 65535UL ;
        ...
        while (width--)
          {
            ...
            a = ((65535UL - *src2_alpha) * *src1_alpha) / 65535UL ;
            b = ((65535UL - *src1_alpha) * *src2_alpha) / 65535UL ;
            alpha = a + b;
  ...
  guint16 *src2_data[4];
    ...
    switch(self->composite_mode)
      ...
      case GEGL_COMPOSITE_MODE_REPLACE:
	    ...
	    *dest_r = (*src2_r * *src2_alpha) / 65535UL ;
	    *dest_g = (*src2_g * *src2_alpha) / 65535UL ;
	    *dest_b = (*src2_b * *src2_alpha) / 65535UL ;
        ...
        while (width--)
          {
            ...
            a = ((255L - *src2_alpha) * *src1_alpha) / 255L   ;
            b = *src2_alpha;
            alpha = a + b;
            ...
            *dest_alpha = alpha;
            ...
            if (alpha)
              {
                *dest_r = (((a * *src1_r) / 255L    + (b * *src2_r) / 255L   ) * 255L) / alpha;
                *dest_g = (((a * *src1_g) / 255L    + (b * *src2_g) / 255L   ) * 255L) / alpha;
                *dest_b = (((a * *src1_b) / 255L    + (b * *src2_b) / 255L   ) * 255L) / alpha;
              }
            else
              {
                *dest_r = *src1_r;
        ...
        while (width--)
          {
            ...
            alpha = (*src1_alpha * *src2_alpha) / 255L   ;
        ...
        while (width--)
          {
            ...
            alpha = ((255L - *src1_alpha) * *src2_alpha) / 255L   ;
        ...
        while (width--)
          {
            ...
            a = ((255L - *src2_alpha) * *src1_alpha) / 255L   ;
            b = ((255L - *src1_alpha) * *src2_alpha) / 255L   ;
            alpha = a + b;
  ...
  guint8 *src2_data[4];
    ...
    switch(self->composite_mode)
      ...
      case GEGL_COMPOSITE_MODE_REPLACE:
	    ...
	    *dest_r = (*src2_r * *src2_alpha) / 255L   ;
	    *dest_g = (*src2_g * *src2_alpha) / 255L   ;
	    *dest_b = (*src2_b * *src2_alpha) / 255L   ;
