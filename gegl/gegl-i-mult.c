...
static void a_imult_b_float (GeglFilter * filter, GeglImageBufferIterator ** iters, gint width);
static void a_imult_b_uint8 (GeglFilter * filter, GeglImageBufferIterator ** iters, gint width);                       
