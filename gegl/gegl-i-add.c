...
static void a_iadd_b_float (GeglFilter * filter, GeglImageDataIterator ** iters, gint width);
static void a_iadd_b_uint8 (GeglFilter * filter, GeglImageDataIterator ** iters, gint width);                       
