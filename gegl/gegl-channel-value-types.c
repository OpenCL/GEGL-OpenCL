...
{
  value->data[0].v_pointer = gegl_channel_space_instance("uint8");
...
{
  value->data[0].v_pointer = gegl_channel_space_instance("float");
                        ...
                        GValue *dest_value)
{
...

  {
    ...
    gegl_channel_space_convert_value_from_float(dest_channel_space, 
                                             dest_value, 
                                             &float_value);
  }
}
                        ...
                        guint8    v_uint8)
{
  ...
  g_return_if_fail (value->data[0].v_pointer == 
                    gegl_channel_space_instance("uint8"));
...
g_value_get_channel_uint8 (const GValue *value)
{
  ...
  g_return_val_if_fail (value->data[0].v_pointer == 
                        gegl_channel_space_instance("uint8"), 0);
                        ...
                        gfloat  v_float)
{
  ...
  g_return_if_fail (value->data[0].v_pointer == 
                    gegl_channel_space_instance("float"));
...
g_value_get_channel_float (const GValue *value)
{
  ...
  g_return_val_if_fail (value->data[0].v_pointer == 
                        gegl_channel_space_instance("float"), 0);
...
{
  GeglChannelSpace * channel_space = value->data[0].v_pointer;
  gchar * name = "none"; 
