...
struct _GeglTileIteratorClass
{
  ...
  gdouble  * (* get_colors)       (GeglTileIterator       *self,
                                   gdouble                *pixel);
  void       (* set_colors)       (GeglTileIterator       *self,
                                   const gdouble          *pixel);
  gdouble    (* get_alpha)        (GeglTileIterator       *self);
  gdouble    (* set_alpha)        (GeglTileIterator       *self,
                                   gdouble                 alpha);
  gdouble    (* get_sample)       (GeglTileIterator       *self);
  gdouble    (* set_sample)       (GeglTileIterator       *self,
                                   gdouble                 sample);
  gdouble  * (* get_colors_amult) (GeglTileIterator       *self,
                                   gdouble                *pixel);
  void       (* set_colors_amult) (GeglTileIterator       *self,
                                   const gdouble          *pixel);
  void       (* set_pixel)        (GeglTileIterator       *self,
                                   const gdouble           pixel);
  gdouble  * (* get_pixel)        (GeglTileIterator       *self,
                                   gdouble                *pixel);
 ...
 */
gdouble * gegl_tile_iterator_get_colors       (GeglTileIterator       *self,
                                               gdouble                *pixel);
void      gegl_tile_iterator_set_colors       (GeglTileIterator       *self,
                                               const gdouble          *pixel);
gdouble   gegl_tile_iterator_get_alpha        (GeglTileIterator       *self);
gdouble   gegl_tile_iterator_set_alpha        (GeglTileIterator       *self,
                                               gdouble                 alpha);
...
gdouble   gegl_tile_iterator_set_sample       (GeglTileIterator       *self,
                                               gdouble                 sample);
...
void      gegl_tile_iterator_set_pixel        (GeglTileIterator       *self,
                                               const gdouble          *pixel);
gdouble * gegl_tile_iterator_get_pixel        (GeglTileIterator       *self,
                                               gdouble                *pixel);
...
#endif /* __GEGL_TILE_ITERATOR_H__ */
