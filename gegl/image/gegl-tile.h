...
struct _GeglTile
{
  ...
  */
  gint x_offset;
  gint y_offset;
  /* The sample_model, color_model and color_space
     are just references to the containing images
     color_model, sample_model, and color_space.
     They are read only.
  */
...
GeglTile *gegl_tile_init_shared (GeglTile* source, gint x_offset, gint y_offset);
